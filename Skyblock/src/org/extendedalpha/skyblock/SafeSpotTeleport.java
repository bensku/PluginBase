...
public class SafeSpotTeleport {
     ...
     */
    public SafeSpotTeleport(final Skyblock plugin, final Entity player, final Location l, final String failureMessage) {
     ...
     * @param setHome
     */
    public SafeSpotTeleport(final Skyblock plugin, final Entity player, final Location l, final int number) {
     ...
     * @param l
     */
    public SafeSpotTeleport(final Skyblock plugin, final Entity player, final Location l) {
     ...
     * @param islandLoc
     */
    public SafeSpotTeleport(final Skyblock plugin, final Entity entity, final Location islandLoc, final int homeNumber, final String failureMessage, final boolean setHome) {
	this.plugin = plugin;
	...
	if (island != null) {
		...
		public void run() {
			...
			plugin.getServer().getScheduler().runTask(plugin, new Runnable() {
				...
				/*
				if (world.equals(Skyblock.getNetherWorld())) {
				    for (int x = -1; x < 3; x++) {
					for (int y = -1; y< 4; y++) {
