...
import org.extendedalpha.core.io.FileResourceLoader;
...
public class ResourceHandler
{
	...
	private final EAPermissionPlugin plugin;
	public ResourceHandler(EAPermissionPlugin plugin)
	{
		this(plugin, plugin.classLoader());
	}

	public ResourceHandler(EAPermissionPlugin plugin, ClassLoader classLoader)
	{
		this.plugin = plugin;
