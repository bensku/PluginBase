package org.extendedalpha.pluginbase.nms;

import java.lang.reflect.InvocationTargetException;

import org.bukkit.plugin.Plugin;
import org.extendedalpha.pluginbase.nms.api.NMSAbstraction;
import org.extendedalpha.pluginbase.nms.v1_8_R3.NMSHandler;
...
public class NMSHelper {
    ...
    public static NMSAbstraction init(Plugin plugin, boolean fallbackOk) throws ClassNotFoundException, IllegalArgumentException,
        ...
        // NOTE: this assumes that extendedalpha-pluginbase is shaded into the plugin as <plugin-main-package>.extendedalpha-pluginbase
        Class<?> clazz;
        try {
            clazz = Class.forName(pluginPackageName + ".extendedalpha.pluginbase.nms." + version + ".NMSHandler");
