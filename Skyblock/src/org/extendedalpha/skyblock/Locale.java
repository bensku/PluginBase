...
public class Locale {
    ...
    public String islandhelpShop;
    public String islandShopTitle;
    ...
    public String shopYouBought;
    public String shopSellProblem;
    public String shopYouSold;
    public String shopBuyProblem;
    public String shopYouCannotAfford;
     ...
     */
    public Locale(Skyblock plugin, String localeName) {
	this.plugin = plugin;
	...
	if (Settings.GAMETYPE.equals(Settings.GameType.ASKYBLOCK)) {
	    ...
	    islandhelpSpawn = ChatColor.translateAlternateColorCodes('&', locale.getString("island.helpIslandSpawn", "go to Skyblock spawn."));
	    newsHeadline = ChatColor.translateAlternateColorCodes('&', locale.getString("news.headline", "[Skyblock News] While you were offline..."));
	...
	islandDonate = locale.getString("island.donate", "Skyblock by ExileDev, click here to donate via PayPal!");
	islandTitle = locale.getString("island.title", "Skyblock");
	islandURL = locale.getString("island.url", "https://www.paypal.com/us/cgi-bin/webscr?cmd=_flow&SESSION=zXyu7nP-t1za-1sYSyWCzNCntM-DFIeivfGLWjSrjDyvAvqurPeDAervVxm&dispatch=50a222a57771920b6a3d7b606239e4d529b525e0b7e69bf0224adecfb0124e9b61f737ba21b081984719ecfa9a8ffe80733a1a700ced90ae");
	...
	purgeSkyBlockFound = ChatColor.translateAlternateColorCodes('&', locale.getString("purge.skyblockFound", "There are [number] unowned islands. Do '/sbadmin purge unowned confirm' to delete them within 20 seconds."));
	...
	islandhelpShop = ChatColor.translateAlternateColorCodes('&', locale.getString("shop.islandhelpShop", "Opens the Shop"));
	islandShopTitle = ChatColor.translateAlternateColorCodes('&', locale.getString("shop.title", "Shop"));
	if (islandShopTitle.length() > 30) {
	    islandShopTitle = islandShopTitle.substring(0, 29);
	}
	shopBuy = ChatColor.translateAlternateColorCodes('&', locale.getString("shop.buy", "Buy(Left Click)"));
	shopSell = ChatColor.translateAlternateColorCodes('&', locale.getString("shop.sell", "Sell(Right Click)"));
	shopYouBought = ChatColor.translateAlternateColorCodes('&',
		locale.getString("shop.youbought", "You bought [number] [description] for [price]"));
	shopSellProblem = ChatColor.translateAlternateColorCodes('&',
		locale.getString("shop.sellproblem", "You do not have enough [description] to sell."));
	shopYouSold = ChatColor.translateAlternateColorCodes('&',
		locale.getString("shop.yousold", "You sold [number] [description] for [price]"));
	shopBuyProblem = ChatColor.translateAlternateColorCodes('&',
		locale.getString("shop.buyproblem", "There was a problem purchasing [description]"));
	shopYouCannotAfford = ChatColor.translateAlternateColorCodes('&',
		locale.getString("shop.youcannotafford", "You cannot afford [description]!"));
	shopOutOfStock = ChatColor.translateAlternateColorCodes('&', locale.getString("shop.outofstock", "Out Of Stock"));
