...
import org.extendedalpha.skyblock.events.WarpListEvent;
import org.extendedalpha.skyblock.util.Util;
import org.extendedalpha.skyblock.util.VaultHelper;

/**
 * Handles warping in Skyblock Players can add one sign
 * 
 * @author ExileDev
 * 
 */
public class WarpSigns implements Listener {
     ...
     * @param plugin
     */
    public WarpSigns(Skyblock plugin) {
	this.plugin = plugin;
	...
	if (b.getWorld().equals(Skyblock.getIslandWorld())) {
