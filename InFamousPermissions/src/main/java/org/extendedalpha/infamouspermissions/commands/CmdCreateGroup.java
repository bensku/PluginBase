...
public class CmdCreateGroup extends InFamousPermissionsCommand
{
	public CmdCreateGroup(InFamousPermissions plugin)
	{
		super(plugin);
		this.name = "create";
	...
	public void perform()
	{
		...
		sendpMessage("Group &6{0} &6successfully created!", group.getName());
	}
}