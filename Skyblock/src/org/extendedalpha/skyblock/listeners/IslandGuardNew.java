...
public class IslandGuardNew implements Listener {
    ...
    public IslandGuardNew(final Skyblock plugin) {
	this.plugin = plugin;
	...
	if (e.getRightClicked() != null && e.getRightClicked().getType().equals(EntityType.ARMOR_STAND)) {
	    ...
	    if (island !=null && (island.getMembers().contains(e.getPlayer().getUniqueId()) || island.getIgsFlag(Island.Flags.allowArmorStandUse))) {
		return;
	    }
	...
	if (inHand != null && inHand.getType().equals(Material.ARMOR_STAND)) {
	    ...
	    if (island !=null && (island.getMembers().contains(p.getUniqueId()) || island.getIgsFlag(Island.Flags.allowPlaceBlocks))) {
	...
	if (e.getDamager() instanceof Player) {
	    ...
	    if (island != null && island.getIgsFlag(Island.Flags.allowBreakBlocks)) {
		return;
	    }
