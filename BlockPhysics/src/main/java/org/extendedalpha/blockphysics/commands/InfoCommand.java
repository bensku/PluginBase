...
import org.extendedalpha.blockphysics.PerWorldConfiguration;
...
public class InfoCommand extends AbstractCommand {
    ...
    public InfoCommand() {
        super("blockphysics info", 0, 1);
        setPermissionNode("blockphysics.commands.info");
    ...
    public boolean execute(Plugin plugin, CommandSender sender, String[] args) {
        ...
        if (args.length == 0) {
            ...
            EAValidate.notNull(w, "Unknown world: " + args[0]);
        }

        MessagePager pager = MessagePager.getPager(sender).clear().setParseColours(true);

        BlockPhysicsPlugin lPlugin = (BlockPhysicsPlugin) plugin;
