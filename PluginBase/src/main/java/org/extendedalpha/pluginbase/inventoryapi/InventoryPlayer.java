...
public class InventoryPlayer extends CraftInventoryPlayer {

    public InventoryPlayer(PlayerInventory inventory) {
        super(inventory);
    }

    public InventoryPlayer(CraftInventoryPlayer inventory) {
