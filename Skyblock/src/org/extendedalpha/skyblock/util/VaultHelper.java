...
public class VaultHelper {
	...
	RegisteredServiceProvider<Economy> economyProvider = Skyblock.getPlugin().getServer().getServicesManager()
	...
	RegisteredServiceProvider<Permission> permissionProvider = Skyblock.getPlugin().getServer().getServicesManager()
