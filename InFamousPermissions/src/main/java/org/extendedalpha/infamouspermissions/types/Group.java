...
public abstract class Group extends Permissible
{
	...
	public Group(InFamousPermissions plugin, String name, String world)
	{
	...
	public Group(InFamousPermissions plugin, String name, String world, MemorySection section)
	{
