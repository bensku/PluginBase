...
public class CmdRealName extends InFamousPermissionsCommand
{
	public CmdRealName(InFamousPermissions plugin)
	{
		super(plugin);
		this.name = "realname";
	...
	public void perform()
	{
		...
		sendpMessage("&r{0} &6is &6{1}&6.", user.getDisplayName(), user.getName());
	}
}