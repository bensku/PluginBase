...
public abstract class UserCommand extends InFamousPermissionsCommand
{
	protected User user;
	protected World world;
	protected @Getter String action = "";

	public UserCommand(InFamousPermissions plugin)
	{
		super(plugin);
	...
	public String getUsageTemplate(boolean displayHelp)
	{
		...
		ret.append(String.format("&6/%s &6user &7<user> &6", plugin.getCommandHandler().getCommandPrefix()));
