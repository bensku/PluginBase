...
package org.extendedalpha.eapermissions.conversion;
...
import org.extendedalpha.core.io.UUIDFetcher;
...
public class PermissionsExConverter
{
	...
	public PermissionsExConverter(File file, EAPermissions plugin)
	{
		this.plugin = plugin;
