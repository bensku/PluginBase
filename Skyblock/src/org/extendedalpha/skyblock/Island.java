...
public class Island {
     ...
     * @param serial
     */
    public Island(Skyblock plugin, String serial) {
	this.plugin = plugin;
	...
	try {
	    ...
	    this.world = Skyblock.getIslandWorld();
     ...
     * @param minZ
     */
    public Island(Skyblock plugin, int x, int z) {
	this(plugin, x, z, null);
    }

    public Island(Skyblock plugin, int x, int z, UUID owner) {
	this.plugin = plugin;
	...
	if (world != null) {
	    ...
	    if (target.getWorld().equals(world) || (Settings.createNether && Settings.newNether && target.getWorld().equals(Skyblock.getNetherWorld()))) {
	...
	if (target.getWorld().equals(Skyblock.getIslandWorld()) || target.getWorld().equals(Skyblock.getNetherWorld())) {
