...
public class SkyblockAPI {
    private static SkyblockAPI instance = new SkyblockAPI(Skyblock.getPlugin());

    /**
     * @return the instance
     */
    public static SkyblockAPI getInstance() {
	return instance;
    }

    private Skyblock plugin;

    private SkyblockAPI(Skyblock plugin) {
	this.plugin = plugin;
    }
	...
	return Skyblock.getIslandWorld();
    }
	...
	return Skyblock.getNetherWorld();
    }
