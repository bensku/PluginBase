package org.extendedalpha.pluginbase.annotation;
...
@SupportedAnnotationTypes("org.extendedalpha.pluginbase.annotation.*")
...
public class PluginAnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annots, RoundEnvironment rEnv) {
        ...
        processingEnv.getMessager().printMessage(Diagnostic.Kind.WARNING, "NOTE: You are using org.extendedalpha.pluginbase.annotation, an experimental API!");
