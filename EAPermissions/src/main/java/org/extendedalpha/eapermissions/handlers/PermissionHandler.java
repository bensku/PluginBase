...
public class PermissionHandler implements Reloadable
{
	...
	public PermissionHandler(EAPermissions plugin)
	{
		this.plugin = plugin;
	...
	public final boolean hasPermission(CommandSender sender, org.extendedalpha.eapermissions.types.Permission permission)
	{
