...
import org.extendedalpha.pluginbase.subapi.chat.ComponentSerializer;
...
import org.extendedalpha.pluginbase.subapi.types.Versioning;
...
public final class Reflection
{
	 ...
	 * by checking the player's client {@link Versioning.Version} against the supported
	 * version.
	 *
	...
	/**
	 * Returns the client {@link Versioning.Version} a given {@link Player} is using.
	 *
	...
	public static Packet getChatPacket(final BaseComponent... components) throws ReflectionException
	{
		...
		LogHandler.globalDebug("Falling back to SubAPI wrappers");
