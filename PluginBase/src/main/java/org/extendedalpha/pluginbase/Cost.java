...
@Deprecated
/**
 * @deprecated Use {@link org.extendedalpha.pluginbase.cost.Cost}
 */
public class Cost {
	...
	public void chargePlayer(CommandSender sender) {
		...
		case MONEY:
			if (economy != null && economy.isEnabled()) {
				...
				throw new EAUtilsException("Economy problem: attempt to make economy charge, but no economy plugin available");
			}
			break;
		case ITEM:
			if (getQuantity() > 0)
